...
public class PlayerControl : MonoBehaviour
{
	...
	private Dictionary<Direction, SoldierBox> m_skillBoxDic = new Dictionary<Direction, SoldierBox>();
...
//		}
		...
		{
            SoldierBox skillBox = m_skillBoxDic[Direction.Up];
			skillBox.UseSkill();
		...
		{
            SoldierBox skillBox = m_skillBoxDic[Direction.Right];
			skillBox.UseSkill();
		}

		if (Input.GetKeyDown(KeyCode.S))
		{
            SoldierBox skillBox = m_skillBoxDic[Direction.Down];
			skillBox.UseSkill();
		}

		if (Input.GetKeyDown(KeyCode.A))
		{
            SoldierBox skillBox = m_skillBoxDic[Direction.Left];
			skillBox.UseSkill();
		}
